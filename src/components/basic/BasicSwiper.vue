<template>
    <section class="swiper">
        ...
        <button class="iconfont icon-left-angle pic-btn priv-pic" @click="privPic"></button>
        <button class="iconfont icon-arrow-right pic-btn next-pic" @click="nextPic"></button>
    </section>
</template>
<script>
export default {
    ...
    methods:{
        ...
        nextPic(){
            this.swiperClassList.unshift(this.swiperClassList[this.swiperClassList.length-1]);
...
.swiper{
    ...
    .swiper-wrap{
        ...
        .slider-leave-from,.slider-fade-enter-active,.slider-leave-to,.slider-fade-enter{
            opacity: 1;
        }
        .slider-leave-to{
            left: 0;
